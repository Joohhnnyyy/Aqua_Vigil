        ...
        <section className="pb-24 px-8 lg:px-20">
          <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div>
              <form onSubmit={handleSubmit} className="space-y-12">
                <div className="relative group">
                  <label className="block text-[14px] font-bold uppercase mb-4 tracking-wider">
                    Name*
                  </label>
                  <input
                    type="text"
                ...
                >
                  <span className="text-[18px] font-bold uppercase tracking-widest relative z-10">
                    [ Send message ]
                  </span>
                </button>
              </form>
            ...
            <div className="space-y-24 pt-4">
              <div>
                <h3 className="text-[14px] font-bold uppercase mb-8 tracking-widest text-[#666666]">
                  Locate us
                </h3>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <span className="block text-[12px] uppercase mb-1 font-bold text-[#666666]">
                      Mail
                    </span>
                    <a
                  ...
                  <div>
                    ...
                    <div className="flex gap-6 mt-2">
                      <a
                        href="#"
                        className="text-[18px] font-bold underline hover:no-underline"
                      >
                        Instagram
                      </a>
                      <a
